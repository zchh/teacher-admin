                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td><!-- Button trigger modal -->
                                <a href="/admin_moreUserPowerGroup/{{$data->group_id}}" class="btn btn-info btn-sm">详情</a>
                                    ...
                                    <div class="modal fade" id="del_{{$data->group_id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="/admin_dUserPowerGroup/{{$data->group_id}}" class="btn btn-danger btn-sm">删除</a>
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">返回</button>
                                                </div>
                                            </div>
                                        </div>
