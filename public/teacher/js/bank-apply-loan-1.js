$(document).ready(function() {
  ...
  $('.btn-next').on('click', function() {
    if ($('#checkBoxTypeE').is(':checked') || $('#checkBoxTypeF').is(':checked')) {
      $('.modal').show();
  ...
  $('.btn-agree').on('click', function() {
    if ($('#checkBoxTypeF').is(':checked')) {
      //window.location.href="bank-apply-loan-f2.html";
    }
    else if($('#checkBoxTypeE').is(':checked')) {
      //window.location.href="bank-apply-loan-enterprise2.html";
    }
  });
